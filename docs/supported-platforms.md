...
This application supports **1800+ video platforms** through [yt-dlp](https://github.com/yt-dlp/yt-dlp) integration.

## 🎯 Most Popular Platforms

### 📺 **Video Sharing**
- **YouTube** - Complete support with SponsorBlock integration
- **Vimeo** - Professional video hosting platform
- **Dailymotion** - European video sharing platform
- **TikTok** - Short-form mobile videos
- **Instagram** - Video posts and stories (authentication required)
- **Facebook** - Video posts and reels (authentication required)

### 🎮 **Live Streaming & Gaming**
- **Twitch** - Gaming streams, VODs, and clips
...
- **BBC iPlayer** - UK public broadcasting (geo-restricted)
...
- **Archive.org** - Internet Archive videos

## 🔍 Testing Platform Support

1. **Try any URL**: Paste the video URL into the application
2. **Automatic Detection**: The system will automatically check if the platform is supported
3. **Error Messages**: If unsupported, you'll get a clear error message

## ⚠️ Platform-Specific Notes

### Authentication Required
Some platforms require browser cookies for access:
- **Facebook/Instagram**: Most content requires login
- **Private Videos**: YouTube private/unlisted content
- **Age-Restricted**: YouTube 18+ content
- **Premium Content**: Platform-specific subscriber content

### Geographic Restrictions
Some content may be geo-restricted:
- **BBC iPlayer**: UK-only content
- **France TV**: French IP addresses preferred
- **Regional Content**: Some platforms limit access by country

### Quality Limitations
- **TikTok**: Mobile-optimized quality
- **Instagram Stories**: Lower resolution
- **Live Streams**: May have encoding limitations

## 📋 Complete Platform List

> **Note**: The following list shows all supported extractors. Some may be for specific content types (playlists, channels, etc.) or may be currently broken.

### Currently Supported Platforms (1800+)
...
tubitv:series
Tumblr
tunein:shortener (CURRENTLY BROKEN)
TuneInPodcast
...
> **💡 Tip**: This list is automatically generated and represents all extractors available in yt-dlp. Some extractors may be specialized (for playlists, channels, etc.) or temporarily broken.

For the most up-to-date list, run: `yt-dlp --list-extractors`
